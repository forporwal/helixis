  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-colors disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-hairline bg-surface text-ink-secondary hover:bg-sunken hover:text-ink",
        ghost: "text-ink-secondary hover:bg-sunken hover:text-ink",
        /* "View Report"-style quiet action: indigo label on a tinted chip */
        soft: "border border-hairline bg-surface text-primary hover:border-hairline-strong hover:bg-sunken",
      },
      size: {
